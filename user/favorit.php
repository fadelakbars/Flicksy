...
// Simulasi koneksi ke database (misalnya, untuk mengambil data gambar/video)
$videos = [
    [
        "title" => "Welcome to samdalri",
        "description" => "Flicksy Original",
        "image" => "" // Gambar kosong untuk video pertama
    ],
    [
        "title" => "Welcome to samdalri",
        "description" => "Flicksy Original",
        "image" => "" // Gambar kosong untuk video kedua
    ],
    [
        "title" => "Welcome to samdalri",
        "description" => "Flicksy Original",
        "image" => "" // Gambar kosong untuk video ketiga
    ]
];
?>
<!DOCTYPE html>
<html>
 <head>
  ...
  <style>
   /* CSS yang telah ada, tetap tidak berubah */
   body {
